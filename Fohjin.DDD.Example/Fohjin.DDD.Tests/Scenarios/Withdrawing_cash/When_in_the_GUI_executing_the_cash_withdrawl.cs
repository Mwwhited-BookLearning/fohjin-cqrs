...
namespace Fohjin.DDD.Tests.Scenarios.Withdrawing_cash;
...
public class When_in_the_GUI_executing_the_cash_Withdrawal : PresenterTestFixture<AccountDetailsPresenter>
{
    ...
    {
        On<FohjinApiClient>().VerifyThat.Method(x => x.WithdrawalCashAsync(It.IsAny<Guid>(), It.IsAny<WithdrawalCashRequest>())).WasCalled();
    }
