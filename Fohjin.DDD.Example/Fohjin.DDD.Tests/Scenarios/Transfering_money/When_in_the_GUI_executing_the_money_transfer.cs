...
public class When_in_the_GUI_executing_the_money_transfer : PresenterTestFixture<AccountDetailsPresenter>
{
    protected override void SetupDependencies()
    {
        ...
        OnDependency<IAccountDetailsView>()
            ...
            .Returns(new AccountReport { Id = Guid.NewGuid(), ClientDetailsReportId = Guid.NewGuid(), AccountName = "Account name", AccountNumber = "1234567890" });
    }
    ...
    {
        On<FohjinApiClient>().VerifyThat.Method(x => x.SendMoneyTransferAsync(It.IsAny<Guid>(), It.IsAny<SendMoneyTransferRequest>())).WasCalled();
    }
