...
public class When_in_the_GUI_saving_the_new_client_name : PresenterTestFixture<ClientDetailsPresenter>
{
    ...
    protected override void SetupDependencies()
    {
        ...
        OnDependency<FohjinApiClient>()
            .Setup(x => x.ChangeClientNameAsync(It.IsAny<Guid>(), It.IsAny<ChangeClientNameRequest>()))
    ...
    {
        On<FohjinApiClient>().VerifyThat.Method(x => x.ChangeClientNameAsync(It.IsAny<Guid>(), It.IsAny<ChangeClientNameRequest>())).WasCalled();
    }
