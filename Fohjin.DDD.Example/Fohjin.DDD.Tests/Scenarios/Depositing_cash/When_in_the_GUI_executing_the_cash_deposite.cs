...
namespace Fohjin.DDD.Tests.Scenarios.Depositing_cash;
...
public class When_in_the_GUI_executing_the_cash_Deposit : PresenterTestFixture<AccountDetailsPresenter>
{
    ...
    {
        On<FohjinApiClient>().VerifyThat.Method(x => x.DepositCashAsync(It.IsAny<Guid>(), It.IsAny<DepositCashRequest>())).WasCalled();
    }
