...
public class When_triggering_behavior_on_the_aggregate_root_and_its_childeren_the_event_versions_will_match : AggregateRootTestFixture<TestAggregateRoot>
{
    ...
    {
        PublishedEvents.LastMinus<IDomainEvent>(3)?.Version.WillBe(0);
    }
    ...
    {
        PublishedEvents.LastMinus<IDomainEvent>(2)?.Version.WillBe(1);
    }
    ...
    {
        PublishedEvents.LastMinus<IDomainEvent>(1)?.Version.WillBe(2);
    }
    ...
    {
        PublishedEvents.LastMinus<IDomainEvent>(0)?.Version.WillBe(3);
    }
