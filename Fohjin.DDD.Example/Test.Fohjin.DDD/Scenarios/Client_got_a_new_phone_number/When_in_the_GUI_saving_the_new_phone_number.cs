...
public class When_in_the_GUI_saving_the_new_phone_number : PresenterTestFixture<ClientDetailsPresenter>
{
    ...
    protected override void SetupDependencies()
    {
        ...
        OnDependency<FohjinApiClient>()
            .Setup(x => x.ChangeClientPhoneNumberAsync(It.IsAny<Guid>(), It.IsAny<ChangeClientPhoneNumberRequest>()))
    ...
    {
        On<FohjinApiClient>().VerifyThat.Method(x => x.ChangeClientPhoneNumberAsync(It.IsAny<Guid>(), It.IsAny<ChangeClientPhoneNumberRequest>())).WasCalled();
    }
